...
import LandingPortrait from './../../../Images/LandingPortrait.jpg'
    ...
    <div className='md:flex md:flex-row md:justify-evenly md:mt-10 pb-5'>
      <div className="font-bold text-4xl mt-9 w-[90%] ml-4 md:w-[40%] md:text-5xl 
        ...
        Shop the outfit that fits you perfectly
          ...
          <button 
              className='rounded-3xl mt-5 text-base font-semibold hover:shadow-2xl bg-gray-950 hover:bg-white hover:text-black hover:border-2 hover:border-black hover:underline duration-500 h-[50px] text-white w-[80%] sm:w-[40%]
