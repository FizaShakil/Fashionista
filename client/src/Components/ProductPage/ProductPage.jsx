...
const ProductPage = () => {
  ...
  useEffect(() => {
    axiosInstance.get(`/api/v1/products/get-single-product-details/${productId}`)
  ...
  return (
    <div className="product-details md:flex md:flex-row py-8 w-[80%] md:justify-around mx-auto">
      ...
      <div className='pt-10 sm:w-[50%]'>
        ...
        <p className='pt-2'>{product.description}</p>
        <button
          className='border-[2px] bg-black text-white px-5 py-2 mt-3 hover:underline hover:bg-slate-50 hover:border-2 hover:border-black hover:text-black duration-200'
